	...
	<div class="card border-info container" style="max-width: 46rem;">
		<div class="card-body">
			<form class="needs-validation" novalidate method="POST"
				onsubmit="return main()" action="/ToYoDo/CustomerLogin">
				<h3>Customer Login</h3>
				<div class="form-group">
					<label for="validUsername">Customer ID/Name</label> <input type="text"
						class="form-control" id="customerNameID" name="customerNameID"
						placeholder="Enter Customer ID or Name" aria-describedby="inputGroupPrepend"
						required>
